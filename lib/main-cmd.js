...
console.log(`𝑷𝑹𝑶𝑺-𝑿𝑫 ♻ Auto Bio Started`);
//============================ Env=======================================================
...
try{
    ...
    let ping = await conn.sendMessage(from , { text: '*_𝑷𝑹𝑶𝑺-𝑿𝑫..._*'  }, { quoted: mek } )
...
try{
let dec = `> 𝑷𝑹𝑶𝑺-𝑿𝑫 REPO INFO 🪀

╭⦁⦂⦁*━┉━┉━┉━┉━┉━┉━⦁⦂⦁
┃ 𝙾𝚆𝙽𝙴𝚁 𝙽𝚄𝙼𝙱𝙴𝚁: ${bot.OWNER_NUMBER}
┃ 
┃ 𝑷𝑹𝑶𝑺-𝑿𝑫 REPO: ${bot.REPO_LINK} 
┃
